...
angular.module('stSpots')
  .controller('MainController', [
    ...
    function($scope, $http, $sce, $compile) {
      ...
      function toast() {
        if ($scope.data.state === 'state_start') {} else if ($scope.data.state ===
          'state_upload') {
          toastr.clear();
      ...
      $scope.setCy3Active = function(active) {
        ...
        for (var [layer, visible] of [
            ['cy3', $scope.data.cy3Active],
      ...
      $scope.aligner = new(function() {
        ...
        this.open = function() {
          ...
          $scope.layerManager.layerOrder.splice(0, 2, 'cy3', 'he');
          $scope.layerManager.setActiveLayer('he', true);
          $scope.toolsManager.activeTool('move');
        }.bind(this);
        this.exit = function() {
      ...
      $scope.uploadImage = function(init) {
